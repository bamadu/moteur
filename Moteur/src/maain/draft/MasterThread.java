...
//	}
//	/*
//	 * public void addIdToLink (String link) { if(!
//	 * idPage.values().contains(links)){ tmpId = id_page++; idPage.put(links,
//	 * tmpId); } }
//	 */
//
...
//	}
//
//	// public MasterThread(String url, int maxThreads) throws
//	// XMLStreamException, JDOMException, IOException{
//	public MasterThread(ExecutorService execService, String url) throws XMLStreamException, JDOMException, IOException {
//		System.out.println("[MasterThead->Const()]  Loading ...");
...
//		 */
//		vecteur = new Vecteur(Matrice.MAX_SIZE, (double) (1.0 / nbPages)); // nbPages
//																			// nombre
//																			// de
//																			// noeuds
...
//	 * 
//	 *
//	 *            public static void fillMotPageRelation(String pageWords[],
//	 *            String titre, Map<String, LinkedList<String>> map){ //String
//	 *            pageWords[] = Clean.removePunctuation(page.getContenu()); /*
//	 *            Pour chaque mot de la page on verifie s'il existe dans le
//	 *            dictionnaire algo de recherche dichotomique
//	 *
//	 *            for(String word : pageWords){ if( Utils.recherche(word,
//	 *            dico.getSortDataFinal())){ if(map.get(word) == null){//
//	 *            map.put(word, new LinkedList<String>()); } else{
