...
public class Utils {
	...
	public static Vecteur calculatePageRank(Matrice m, Vecteur v){
		...
		while(gama < epsilon);
		System.out.println("Nombre d'iteration pour le calclul du Pagerank : "+round);
		return Pk;
	}
	...
	public static void trier(Map<String, LinkedList<Page>> assocMotPageRank) {
		// TODO Auto-generated method stub
		for(String pTitle : assocMotPageRank.keySet()){
			Collections.sort((List<Page>) assocMotPageRank.get(pTitle));
		}
	}
